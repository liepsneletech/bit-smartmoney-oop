...
<?php if(isset($currentPage) && $currentPage !== 'Prisijungimas' && $currentPage !== '404') : ?>
  <header class="header">
    ...
    <div class="header-content-box container">
      <a href="/"><img src="../../assets/img/logo-dark+.png" alt="SmartMoney logo" class="header-logo-desktop"><img src="../../assets/img/logo-dark-mobile.png" alt="SmartMoney logo" class="header-logo-mobile"></a>
      <nav class="main-nav">
        <a class="nav-link <?= $active === 'index' ? 'active' : '' ?>" href="/accounts">Sąskaitos</a>
        <a class="nav-link <?= $active === 'create-account' ? 'active' : '' ?>" href="/create-account">Sukurti sąskaitą</a>
